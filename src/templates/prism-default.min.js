/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+csharp+bash+aspnet+clojure+diff+docker+git+graphql+json+markdown+sql+jsx+yaml+vim&plugins=line-highlight+line-numbers+toolbar+show-language+copy-to-clipboard */
var _self =
