      ...
      <ul className="timeline">
        ...
        <li className="book">
          ...
          <div className="description">
            ...
            <p>
              I am proud to announce that my article that I have been working on
              alongside editor Rose Weisburd has been published on A List Apart.
            </p>
          </div>
        </li>
        <li className="talk">
        ...
        <li className="work">
          ...
          <div className="description">
            ...
            <p>
              I form part of a SCRUM team focusing on the DStv Now website which
              is a Video on Demand service offering Live TV streaming from a
              select number of channels as well as Movies and Series available
              on Catch Up for what is known as OTT (Over The Top) offerings -
              content allowed to be streamed on our platform.
            </p>
            <p>
              ...
              ability to get the right people involved to offer support as well
              as being great at troubleshooting by finding needles in haystacks
              on a distributed scaled platform.
            </p>
          </div>
        </li>
        <li className="blog">
